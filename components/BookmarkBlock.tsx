...
const BookmarkBlock = ({ value }: { value: any }) => {
  const { url } = value;
  ...
  if (error)
    return (
      <a
        ...
        className="relative h-28 my-4 flex items-end p-2 cursor-pointer rounded bg-gray-200 dark:bg-dark-400 border border-gray-400/50 text-gray-600 hover:bg-light-200 dark:text-gray-400 dark:hover:bg-dark-700 overflow-hidden"
      >
        <div>
  ...
  if (!data)
    return (
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="h-28 my-4 grid grid-cols-3 cursor-pointer rounded border border-gray-400/50 text-gray-600 hover:bg-light-200 dark:text-gray-400 dark:hover:bg-dark-700 overflow-hidden"
      >
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="no-underline primary-text grid h-28 cursor-pointer grid-cols-3 justify-between rounded border border-gray-400/50 hover:bg-light-200 dark:hover:bg-dark-700 overflow-hidden my-4"
    >
      <div className="col-span-3 flex flex-shrink flex-col overflow-hidden p-2 sm:col-span-2">
        <div className="mb-1 h-6 truncate text-sm font-bold leading-6 pl-2">
          {title}
        </div>
